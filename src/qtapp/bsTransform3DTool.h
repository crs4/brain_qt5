...
//======================================================================
//---HDR---//
#ifndef BSTRANSFORM3DTOOL_H
#define BSTRANSFORM3DTOOL_H
...
class bsViewer3D;
class bsTransform3DTool: public bsTool3D {
    Q_OBJECT

public:

    bsTransform3DTool(bsEditor3D* editor,
			QWidget* parent,
			const char* name,
			QPixmap* pixmap = NULL,
			QBitmap* bitmask = NULL);

    virtual ~bsTransform3DTool();
