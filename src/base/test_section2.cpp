...
int main() {
  ...
  sl::point2f p8; p8 = -0.5f, 1.2f; 
  sl::point2f p9; p9 =  0.5f, 1.2f;
  sl::point2f p10; p10 =  0.5f, 1.8f;
  sl::point2f p11; p11 = -0.5f, 1.8f;
  ...
  holes[0].push_back(8);
  holes[0].push_back(9);
  holes[0].push_back(10);
  holes[0].push_back(11);
  ...
  std::cerr << "... after triangulation:" << std::endl;
  std::cerr << *s << std::endl;
